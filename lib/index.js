...
var InfiniteScroller = /*#__PURE__*/function (_Component) {
  ...
  function InfiniteScroller() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _super.call.apply(_super, [this].concat(args)), _this.state = {
      list: [],
      boxTop: 0
    }, _this.lock = false, _this.windowHeight = inClient ? (_window = window) === null || _window === void 0 ? void 0 : _window.innerHeight : 700, _this.ref = /*#__PURE__*/_react["default"].createRef(), _this.timeoutKey = null, _this.sortList = function (list) {
      ...
      list.forEach(function (item, index) {
        if (item.is_height) {
          ...
          if (top > minTop && top < maxTop) {
            ...
            if ((lastItem === null || lastItem === void 0 ? void 0 : lastItem.type) === 'block') {
      ...
      return _list;
    }, _this.reportHeight = function (index, height) {
      var list = _this.state.list;
      list[index].is_height = height;

      var key = _this.getMapKey(list[index]);
